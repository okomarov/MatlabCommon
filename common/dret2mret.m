function [mret, mdts] = dret2mret(ret, dts, requireall, refdts, endskip, startskip)
...
if nargin < 3, requireall = true; end
if nargin < 4, refdts = []; end
if nargin < 5, endskip = 0; end
if nargin < 6, startskip = 0; end
